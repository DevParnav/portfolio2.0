...
export default function AboutContent() {
  ...
  return (
    <div className="relative w-full pointer-events-auto flex items-start justify-center px-10 md:px-24 pt-32 pb-0">
      <div ref={containerRef} className="w-full max-w-7xl flex flex-col-reverse md:flex-row items-center md:items-start justify-between gap-20">
        
        {/* Left Side: Text Content */}
        <div className="w-full md:w-[50%] flex flex-col gap-12 pt-10 md:pt-20">
          
          {/* 1. Section Label */}
          <div className="about-left-item">
            <div className="text-[#e5b36e] font-sans text-sm font-medium tracking-[0.4em] uppercase">
              ABOUT ME
            </div>
          </div>

          {/* 2. Main Heading */}
          <div className="about-left-heading font-serif text-4xl md:text-[3.25rem] leading-[1.1] text-white">
            ...
            <div className="overflow-hidden mt-6"><div className="heading-line">The goal isn't</div></div>
            <div className="overflow-hidden"><div className="heading-line text-[#d0cdc4]">just writing code.</div></div>
          </div>

          {/* 3. Description */}
          <div className="flex flex-col gap-6 text-[#a9a7a1] text-lg font-light leading-relaxed">
          ...
          {/* 4. Information Block */}
          <div className="about-left-info grid grid-cols-2 gap-x-8 gap-y-10 pt-4 border-t border-white/10">
            <div>
              <div className="text-white/40 text-xs font-sans tracking-widest uppercase mb-2">Location</div>
              <div className="text-white/90 text-sm font-light">Jaipur, India</div>
            </div>
            <div>
              <div className="text-white/40 text-xs font-sans tracking-widest uppercase mb-2">Education</div>
              <div className="text-white/90 text-sm font-light">B.Tech Computer Science (AI & Data Science)</div>
            </div>
            <div>
              <div className="text-white/40 text-xs font-sans tracking-widest uppercase mb-2">University</div>
              <div className="text-white/90 text-sm font-light">JECRC University</div>
            </div>
            <div>
              <div className="text-white/40 text-xs font-sans tracking-widest uppercase mb-2">Current Focus</div>
          ...
          <div className="pt-4 flex flex-wrap gap-3">
            {["Creative Thinker", "Problem Solver", "Fast Learner", "Building EchoOS"].map((tag) => (
              <div key={tag} className="about-left-tag px-4 py-2 rounded-full border border-white/10 bg-white/5 text-white/70 text-xs font-medium tracking-wide">
                {tag}
              </div>
            ))}
          </div>
          ...
          {/* 6. Button */}
          <div className="about-left-button pt-8">
            <button className="hover-target px-8 py-3.5 bg-white text-black rounded-full text-xs font-medium hover:bg-gray-200 transition-colors">
              Explore My Journey
            </button>
          </div>
        ...
        <div 
          ref={imageRef} 
          className="relative w-full md:w-[500px] aspect-square sticky top-32 flex-shrink-0"
        >
